...
**Random wafer selected from test set** (shape: 1 × 52 × 52 × 3)

**True defect pattern: Loc+Scratch**

<table style="margin: 1.5em auto; font-size: 0.85em;">
<thead>
<tr><th>Model</th><th>Prediction</th><th>Confidence</th><th>Match</th></tr>
</thead>
<tbody>
<tr><td>Custom CNN</td><td>Loc+Scratch</td><td style="color: #4CAF50; font-weight: bold;">99.89%</td><td style="color: #4CAF50;">✓</td></tr>
<tr><td>MobileNetV2</td><td>Loc+Scratch</td><td style="color: #4CAF50; font-weight: bold;">98.48%</td><td style="color: #4CAF50;">✓</td></tr>
</tbody>
</table>

Both models correctly identify the **Loc+Scratch** combination pattern with high confidence — demonstrating that the Phase 2 pipeline generalizes well to unseen wafer maps.
